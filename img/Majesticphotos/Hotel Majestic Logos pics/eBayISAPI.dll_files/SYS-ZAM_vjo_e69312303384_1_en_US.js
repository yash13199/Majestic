...
vjo.ctype("vjo.darwin.core.rtm.RTM").needs(["vjo.dsf.utils.SiteSpeed","vjo.dsf.cookie.VjCookieJar","vjo.dsf.client.Browser","vjo.dsf.client.ActiveX","vjo.dsf.EventDispatcher","vjo.dsf.flash.Version","vjo.dsf.utils.JsLoader","vjo.dsf.utils.CssLoader","vjo.Registry","vjo.dsf.Message","vjo.dsf.Element"]).protos({oJSBean:null,aContent:[],bTimedOut:false,oTimeoutId:null,iTIMEOUT:3000,oClient:null,bRespRet:false,iOrd:0,bb:false,aGlbNavPlac:null,promos:null,globalAdOverlay:null,response:null,renderedStatus:null,bodyLoadedTime:0,renderCSS:false,bPromoScript:false,bPromoStyle:false,ssGaugeVectors:{},bOptimize:false,hasExpAds:false,ExpAd:null,hasAdSurvey:false,AdSurvey:null,E:vjo.dsf.Element,S:vjo.dsf.ServiceEngine,constructs:function(_1){var t=this;t.oJSBean=_1||{};t.oJSBean.quickPids=t.oJSBean.quickPids||[];t.aContent=[];t.bTimedOut=false;t.oTimeoutId=null;t.iTIMEOUT=3000;t.oClient=vjo.dsf.client.Browser;t.bRespRet=false;t.iOrd=(new Date()).getTime();t.bb=false;t.aGlbNavPlac=null;t.promos=new Object();t.globalAdOverlay=null;vjo.Registry.put("GlobalRtmInstance",t);t.response=null;t.renderedStatus={};t.bodyLoadedTime=0;t.renderCSS=false;t.aEvCon=[];t.ExpAd=null;t.AdSurvey=null;t.bOptimize=true;t.hasExpAds=false;t.hasAdSurvey=false;if(t.bOptimize){vjo.dsf.EventDispatcher.add("body","load",t.render,t);}
t.S.registerSvcReqtHdl("RTM_LOAD_PIDS",t);t.ids=t.oJSBean.htmlIds;},handleRequest:function(_3){var t=this,m=_3,b=t.oJSBean,x,n=m.pids.length,id,i,ad,j,cl;var dc=b.delayedContent,ed=b.expandDirections;if(t.bb){return;}
t.loadCSS();for(x=0;x<n;x++){id=m.pids[x];i=t.getIndex(id);if(dc&&dc[i]){if(ed&&ed[i]){t.hasExpAds=true;}
ad={};ad.id=id;ad.type=b.contentTypes[i];ad.width=b.widths[i];ad.height=b.heights[i];ad.content=dc[i];t.processPromo(ad);}else{b.triggerEvent[i]=0;cl=t.aContent.length;for(j=0;j<cl;j++){ad=t.aContent[j];if(ad.id==id){t.processPromo(ad);}}}
if(b.hasSurvey[i]=="true"){t.hasAdSurvey=true;}}
t.loadExtJS();},loadExtJS:function(){var t=this,b=t.oJSBean,l=t.vj$.JsLoader;if(t.hasExpAds&&!t.ExpAd){l.load(b.expJsUrl);}
if(t.hasAdSurvey&&!t.AdSurvey){l.load(b.adSurveyJsUrl);}},getFlashVersion:function(){return this.vj$.Version.get();},getEncodingType:function(){return"UTF-8";},setInlineContent:function(_7){var t=this,b=t.oJSBean,ed,i,ad;if(t.TimedOut()){return;}
t.hidePromos(t.promos);t.aContent=_7;var _9=false;t.bPromoScript=false;t.bPromoStyle=false;t.loadCSS();for(i=0;i<t.aContent.length;i++){ad=t.aContent[i];var gi=t.getIndex(ad.id);ed=b.expandDirections;if(ed&&ed[gi]){ad.expand=ed[gi];}
if(ad.expand){t.hasExpAds=true;}
...
t.loadExtJS();if(typeof(oGaugeInfo)!="undefined"){var c=(new Date()).getTime()-oGaugeInfo.iST;vjo.dsf.utils.SiteSpeed.addParam("ctrc",c);}
t.sendComplete(1);if(_9){m=new vjo.dsf.Message("PROMO_COMPLETE");m.vjPromoClientObject=t;t.S.handleRequest(m);}},sendComplete:function(s){var m=new vjo.dsf.Message("RTM_COMPLETE");m.status=s;m.vjRTMObject=this;this.S.handleRequest(m);},TimedOut:function(){var t=this;t.bRespRet=true;if(t.bTimedOut){return true;}
if(t.oTimeoutId){window.clearTimeout(t.oTimeoutId);}
return false;},processJS:function(_10){var l=this.vj$.JsLoader;if(_10.JSURLs){var _12=_10.JSURLs;for(var i=0;i<_12.length;i++){l.load(_12[i]);}}
if(_10.EventHandlers){var _14=_10.EventHandlers;for(i=0;i<_14.length;i++){l.loadText(_14[i]);}}},loadCSS:function(){var t=this,i,ad,cl=t.aContent.length,md,j,us;if(!t.renderCSS){for(i=0;i<cl;i++){ad=t.aContent[i];if(ad.CSSMetaData){md=ad.CSSMetaData;if(md.CSSURLs){us=md.CSSURLs;for(j=0;j<us.length;j++){t.vj$.CssLoader.load(us[j]);}
t.renderCSS=true;}}}}},processPromoResponse:function(_16){var t=this;var map=_16.content.data.map;var _19=0;var id="-1";var _1b=false;for(var _1c in map){var _1d=_1c.match(/ME([0-9]+)(.*)/);if(_1d){_19++;id=_16.id;}}
...
window.clearTimeout(t.oTimeoutId);t.sendComplete(0);},getBrowserWidth:function(){var w=document.body.clientWidth;if(!this.oClient.bIE){w=window.innerWidth;}
return w;},popUp:function(_70,_71,_72,_73,_74,_75,_76,_77,_78,_79,_7a,_7b){var s="";s+=(_72!=null)?",width="+_72:"";s+=(_73!=null)?",height="+_73:"";s+=(_77!=null)?",screenX="+_77+",left="+_77:"";s+=(_78!=null)?",screenY="+_78+",top="+_78:"";s+=",toolbar="+((_75)?"1":"0");s+=",location="+((_79)?"1":"0");s+=",status="+((_74)?"1":"0");s+=",scrollbars="+((_76)?"1":"0");s+=",resizable="+((_7a)?"1":"0");s+=",menubar="+((_7b)?"1":"0");if(s.length>0){s=s.substring(1);}
window.open(_71,_70,s);return false;},getSegment:function(_7d){var oCJ=this.vj$.VjCookieJar,e=oCJ.readCookie("etfc"),r=oCJ.readCookie("reg"),s=oCJ.readCookie("ebay","sin"),c,n;if(e=="0"){n="3";c="E";}else{if(e=="1"){n="4";c="C";}else{if(e=="2"){n="5";c="D";}else{if((e==""&&(r!=""&&r!=";"))||s=="in"||e=="5"){n="2";c="B";}else{n="1";c="A";}}}}
return _7d?c:n;},getCIDCookie:function(){var oCJ=this.vj$.VjCookieJar;var cid=oCJ.readCookie("npii","cguid");if(cid!="undefined"&&cid!=""){return cid;}},openReportAd:function(_81,_82,_83,_84,_85,_86,_87,_88,_89,_8a,_8b,_8c,_8d,_8e){var t=this;if(t.globalAdOverlay==null){t.globalAdOverlay=new vjo.darwin.core.rtm.ReportAd(_83,_84,_85,_86,_89,_8a,_82,_8b,_8c,_8d,_8e);}
if(t.globalAdOverlay!=null){t.globalAdOverlay.init(_87,_88);t.globalAdOverlay.open(_81);t.globalAdOverlay.setReportAdLinkId(_8e);}
t.E.get("startOfLayer").focus();},closeReportAd:function(){var t=this;if(t.globalAdOverlay!=null){if(t.globalAdOverlay){t.globalAdOverlay.close();}}},submitReportAd:function(){var t=this;if(t.globalAdOverlay!=null){if(t.globalAdOverlay){t.globalAdOverlay.submitReport();}}},yahooAdBckGrnd:function(_92){var f=this.E.get(_92);f.style.visibility="visible";f.parentNode.style.backgroundColor="transparent";},addStatus:function(_94,_95){this.renderedStatus[_94]=_95;},getStatus:function(_96){return this.renderedStatus[_96];},storeResponse:function(_97){var t=this,c=_97,qp,i;t.response=c;t.aContent=c;if(t.bodyLoadedTime>0){t.setInlineContent(c);}else{if(!t.TimedOut()){qp=t.oJSBean.quickPids;if(qp&&qp.length>0){t.renderPromos(qp);}}}
if(c!=null){for(i=0;i<c.length;i++){if(c[i]!=null&&c[i].content!=null&&c[i].content.indexOf("openReportAd")>0){t.addReportAdScript();break;}}
t.loadCSS();}
if(c!=null&&c.indexOf("openReportAd")>0){t.addReportAdScript();}},addReportAdScript:function(){try{if(this.oJSBean.reportAdJsUrl){this.vj$.JsLoader.load(this.oJSBean.reportAdJsUrl);}}
catch(er){}},render:function(){var t=this,r=t.response;if(r){t.setInlineContent(r);}
t.bodyLoadedTime=(new Date()).getTime();},processPromo:function(_9a){var t=this;if(_9a.type=="doubleclick"){t.processDoubleClickAd(_9a);}else{if(_9a.type=="html"){t.processHTMLAd(_9a);}else{if(_9a.type=="popUnder"){t.processPopUnderAd(_9a);}else{if(_9a.type=="promo"){t.bHasPromo=true;t.processPromoResponse(_9a);}else{if(_9a.type=="htmlform"){t.processHTMLFormAd(_9a);}else{t.processNoneAd(_9a);}}}}}},renderPromos:function(_9c){var r=this.response,i,j;if(r){for(j=0;j<r.length;j++){for(i=0;i<_9c.length;i++){if(r[j].id==_9c[i]+""){this.processPromo(r[j]);}}}}},getPids:function(_9e){var p="",l=_9e.length;for(i=0;i<l;i++){p+=_9e[i];if(i!=(l-1)){p+=":";}}
return p;},timer:function(_a0,_a1,_a2){var c=(new Date()).getTime()-oGaugeInfo.iST;var m=_a2,v=this.ssGaugeVectors,i;v[m]=v[m]||{};v[m].t=_a1;if(_a0){v[m].e=c;}else{v[m].s=c;}
var a=[];for(i in v){if(v[i].t==_a1){a.push(i+"|"+v[i].s+"|"+(v[i].e||""));}}
vjo.dsf.utils.SiteSpeed.addParam("ctr"+_a1+"v",a.join(","));}}).props({siteCatalyst:function(_a6,_a7,p,_a9){var esc=vjo.darwin.tracking.sitecatalyst;if(esc){var _ab="Search",loc="North";if(p==188||p==570){_ab="Browse";}
if(p==569||p==570){loc="Sky";}
var s=esc.EbaySiteCatalyst.s;s.linkTrackVars="prop27";s.linkTrackEvents="None";s.prop27=_a7+":"+_ab+":"+p+":"+_a9;if(_a6){s.linkTrackVars="prop28";s.prop28=s.prop27;s.prop27=null;}
s.tl(true,"o","RTM "+loc+" Ad");}}}).endType();

vjo.itype("vjo.dsf.common.IJsServiceHandler").protos({invoke:function(_1){}}).endType();

vjo.ctype("vjo.darwin.core.rtm.RTMInit").needs("vjo.dsf.utils.URL","U").needs("vjo.dsf.EventDispatcher","ED").needs("vjo.darwin.core.rtm.RTM","R").needs("vjo.darwin.core.rtm.RTMHelper","H").needs("vjo.dsf.assembly.VjClientAssembler","V").needs("vjo.dsf.cookie.VjCookieJar").satisfies("vjo.dsf.common.IJsServiceHandler").protos({oRTM:null,constructs:function(_1){var t=this,o=t.vj$;t.oRTM=new o.R(_1);o.H.setRtm(t.oRTM);var b=t.oRTM.oJSBean,s=b.onScrollPids;if(s&&s.length>0){o.ED.addEventListener(window,"scroll",function(){vjo.darwin.core.rtm.RTMOnDemand.onScroll(t.oRTM);},t);}
o.ED.addEventListener(window,"beforeunload",this.bbUnload,this);vjo.dsf.ServiceEngine.registerSvcReqtHdl("RTM_REQUEST_ADS",this);},bbUnload:function(){var t=this,o=t.vj$,j=o.VjCookieJar,c=j.readCookie("ebay","sbf");j.writeCookielet("ebay","sbf",j.setBitFlag(c,20,1));},invoke:function(_5){var t=this,o=t.vj$,r=t.oRTM,b=r.oJSBean,u=b.url,s="",U=o.U,c,gp=r.processGlobalNavPids(true),ge=r.processGlobalNavPids(false);s+="&e=USC:"+r.getSegment(false);var p=U.getArg(u,"p"),ph=U.getArg(u,"ph"),ev=U.getArg(u,"ev");if(gp){if(p!=null&&p.indexOf(gp)==-1){u=u.replace("p="+p,"p="+p+":"+gp);if(ph){u=u.replace("ph="+ph,"ph="+ph+":"+ge);}
...
if(_5.pIds){u=u.replace("p="+p,"p="+r.getPids(_5.pIds));b.url=u;if(_5.callback){t.onSend(_5.callback);}else{t.onSend();}}else{r.registerGlobalNavPlacements();if(b.suppressRtmCmd){return;}
if(!b.onload){t.onSend();}else{o.ED.addEventListener(window,"load",t.onLoad,t);}
o.ED.addEventListener(window,"load",r.setTimeOut,r);_5.returnData=false;}},onLoad:function(){var t=this;window.setTimeout(function(){t.onSend();},0);},handleRequest:function(_9){this.oRTM.setTimeOut();this.onSend();},onSend:function(h){var t=this,o=t.vj$,r=t.oRTM,b=r.oJSBean,u=b.url,s="",bb;var _c=r.bOptimize,f=(_c?r.storeResponse:r.setInlineContent),dd=document.domain||"";f=h?h:f;if(typeof(oGaugeInfo)!="undefined"){s+="&ss=1";bb=oGaugeInfo.bf;}else{var j=o.VjCookieJar,c=j.readCookie("ebay","sbf");bb=c?j.getBitFlag(c,20):0;j.writeCookielet("ebay","sbf",j.setBitFlag(c,20,1));}
if(dd.indexOf("pages.")==0){bb=0;}
r.bb=bb;if(bb){s+="&bb=1";}
u+=s;b.url=u;if(b.mode=="1"&&!bb){if(b.fetchUrl){b.fetchUrl+=s;}
u=b.fetchUrl;}
if(u){var _e=new vjo.dsf.assembly.VjClientAssemblerRequest(u,f,r,"cb",!_c);o.V.load(_e);}else{r.sendComplete(1);r.TimedOut();}}}).endType();
...
// en_US/e693/SYS-ZAM_vjo_e69312303384_1_en_US
// b=12303384